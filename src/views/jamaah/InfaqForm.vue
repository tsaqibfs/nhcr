            ...
            <div v-else-if="form.payment_method === 'transfer'" class="space-y-2">
              ...
              <div class="flex items-center justify-between p-2.5 bg-white border border-slate-200 rounded-xl">
                <div>
                  ...
                  <p class="font-mono font-bold text-slate-700 text-sm mt-0.5">712 3456 789</p>
                  <p class="text-slate-500 text-[10px]">a.n. DKM Masjid Jami SiMajid</p>
                </div>
                <button 
                  type="button" 
                  @click="copyToClipboard('7123456789')"
